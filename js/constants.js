...
export const BOARD_COORDINATE = {
  ...
  innerMidLeftBot:  {x: -1*BOARD_MID_LINE/2 , y: BOARD_HEIGHT, z: DISTANCE_TO_BOARD+BOARD_LENTH-BOARD_SIDE_LINES },
  innerMidLeftTop: {x: -1*BOARD_MID_LINE/2, y: BOARD_HEIGHT, z: DISTANCE_TO_BOARD+BOARD_SIDE_LINES },
  innerMidRightBot:  {x: BOARD_MID_LINE/2 , y: BOARD_HEIGHT, z: DISTANCE_TO_BOARD+BOARD_LENTH-BOARD_SIDE_LINES},
